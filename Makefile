...
LUCI_DEPENDS       := +luci-base +rpcd +rpcd-mod-ucode +ucode-mod-socket +ucode-mod-struct +ucode-mod-uloop +ucode-mod-fs +ucode-mod-html +ucode-mod-uci +ucode-mod-ubus +ucode-mod-digest +liblucihttp-ucode +coreutils-timeout
LUCI_PKGARCH       := all
